...
## Git이란{background-color="black" background-image="https://git-scm.com/images/logos/downloads/Git-Logo-White.png" background-size="cover" background-repeat="center" background-opacity="0.2" class="center"}
...
![](./images/branch-example.png){.absolute top=100 left=100 width=800 height=550 style="background:#FFFFFF;"}
