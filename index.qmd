...
![](https://velog.velcdn.com/images/chlwnstjr94/post/a9e014c5-97c7-473a-aa3e-dcc3bd4e99e5/image.PNG){.absolute top=120 left=80 width=900 height=550}
...
::: {.r-stack}
![](./images/github-desktop_1.png){.fragment width="900" height="600"}

![](./images/github-desktop_2.png){.fragment width="900" height="600"}

![](./images/github-desktop_3.png){.fragment width="900" height="600"}
:::
...
- Add는 커밋할 상태로 파일을 올려두는 것을 의미합니다. 
- Commit은 (임시) 저장이라고 이해하면 편합니다. 
- Commit을 해두면 그 이전 상태로 언제든지 돌아갈 수 있습니다. 
  - 단, Desktop 앱을 통해서는 아닙니다... 
...
- 작업한 내용을 온라인을 통해 동기화 
  - 원격저장소 
- 서로 다른 기기로 작업할 때 유용 
  - PC1 작업 &rarr; Git Push  &rarr; PC2 Git Pull  &rarr; 작업 &rarr; Git Push  &rarr;  $\cdots$
- 여러 명이 협업할 때도 유용 
  - Branch 그리고 Pull Request의 개념이 필요하다. 
:::

## {background-color="black" background-image="./images/Git-PUSH-pULL-1280x640.png" background-size="cover" background-repeat="none" background-opacity="1" transition="none" background-transition="zoom" transition-speed="slow"}
...
## {background-color="white" background-image="./images/github-pages-workflow.png" background-size="cover" background-repeat="center" background-opacity="1" class="center"}
...
- Github Pages를 활용할 예정이기 때문에 Github Desktop 앱으로 만들자. 
