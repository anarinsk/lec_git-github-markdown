...
## {background-color="black" background-image="./images/git_procedure_V2.png" background-size="cover" background-repeat="none" background-opacity="1" transition="none" background-transition="zoom" transition-speed="slow"}
